                    ...
                    <div class="container-fluid">
                        <div class="card-body">
                            ...
                            <table id="example" cellspacing="0" class="table table-hover">
                                ...
                                <?php
                                $showlsp = "select ddh.MaDonDatHang,ddh.NgayLap,ddh.TongThanhTien,ddh.MaTaiKhoan,tk.TenHienThi,dcnh.DiaChiGiaoHang,tt.TenTinhTrang from taikhoan as tk, dondathang as ddh, tinhtrang as tt, diachinhanhang as dcnh
                                                where tk.MaTaiKhoan = ddh.MaTaiKhoan and ddh.MaTinhTrang = tt.MaTinhTrang and dcnh.ID = ddh.DiaChiGiaoHang
                                                and tk.MaTaiKhoan=dcnh.MaTaiKhoan ORDER BY NgayLap DESC";
                                $rslsp = load($showlsp);
                                ...
                                <tr style="text-align:center; <?php if($rowlspl['TenTinhTrang'] == "Đã Giao") echo "background-color: #0eff00a8;" ?>">
                                    ...
                                    <td>
                                        <?php echo $rowlspl['DiaChiGiaoHang']; ?>
                                    </td>
                                    <td>
