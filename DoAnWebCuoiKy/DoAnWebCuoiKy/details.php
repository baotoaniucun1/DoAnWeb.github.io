        ...
        <div class="row" style="padding-top:40px">
            ...
            <div class="col-8 border">
                ...
                <p>
                    ...
                    <h6>
                        <?php echo  $luongban ?> : Lượt mua │
                        <?php $xemtam = $luotxem+1;
                                ...
                                <div class="col-3 col-md-3 mb-4">
                                    <div class="card h-1100">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h5><b>
                                                    <?php echo number_format($row1['GiaSanPham']); ?> ₫</b></h5>
                                ...
                                <div class="col-3 col-md-3 mb-4">
                                    <div class="card h-1100">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h5><b>
                                                    <?php echo number_format($row2['GiaSanPham']); ?> ₫</b></h5>
                                            <div style="text-align: center;">
