...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 23, 2018 lúc 08:50 AM
...
('MDDH003', '2018-12-22 22:39:12', 3980000, 2, 1, NULL),
...
(2, 'Super AMOLED, 5.8\", Quad HD+ (2K+)', 'Android 7.0 (Nougat)', '12 MP', '8 MP', 'Exynos 8895 8 nhân 64-bit', '4 GB', '64 GB', '2 SIM Nano (SIM 2 chung khe thẻ nhớ), Hỗ trợ 4G', '3000 mAh, có sạc nhanh', 'Hàn Quốc'),
...
(11, 'LED-backlit IPS LCD, 4.7\", Retina HD', 'iOS 11', '8 MP', '1.2 MP', 'Apple A8 2 nhân 64-bit', '1 GB', '32 GB', '1 Nano SIM, Hỗ trợ 4G', '1810 mAh', 'Nhật'),
...
(71, 'LTPS LCD, 6.23\", Full HD+', 'ColorOS 5.0 (Android 8.1)', '16 MP', '25 MP', 'MediaTek Helio P60 8 nhân 64-bit', '6 GB', '128 GB', '2 Nano SIM, Hỗ trợ 4G', '3400 mAh', NULL),
...
(1, 'Samsung Galaxy S7', 'assets/img/s7.png', '5990000', NULL, 200, 20, 23, 'Với những nâng cấp tuyệt vời mà Samsung mang lại cho người dùng như khả năng chống nước, thiết kế hoàn hảo, Galaxy S7 sẽ khiến bạn không thể rời mắt.', 0, 3, 2),
...
(26, 'Nokia 5.1 Plus', 'assets/img/nokia5.1+.png', '4790000', '2018-12-31 09:15:44', 200, 1, 8, 'Sau Nokia 6.1 Plus thì Nokia tiếp tục tung ra thị trường chiếc smartphone thứ 2 của mình sở hữu màn hình \"tai thỏ\" với tên gọi Nokia 5.1 Plus (Nokia X5) với mức giá dễ chịu và hấp dẫn.\r\nThiết kế đẳng cấp sang trọng\r\nChiếc điện thoại Nokia sở hữu thiết kế khung kim loại sang trọng và chắc chắn, đem lại vẻ nam tính và mạnh mẽ cho người dùng.', 0, 3, 3),
...
(49, 'Huawei Mate 20 Pro', 'assets/img/hm20p.png', '21990000', NULL, 200, 0, 0, 'Thế hệ siêu phẩm mới của Huawei chính thức lộ diện với cái tên Huawei Mate 20 Pro, chiếc điện thoại thu hút trong thiết kế, mạnh mẽ trong hiệu năng cùng một hệ thống camera ấn tượng.\r\nThiết kế mới mẻ, bắt mắt\r\nSang trọng và đẳng cấp là những từ mà bạn có thể thốt lên khi chiêm ngưỡng thân hình của siêu phẩm Huawei Mate 20 Pro.', 0, 1, 4),
...
(54, 'Samsung Galaxy J2 Prime', 'assets/img/j2p.png', '2290000', '2018-12-14 09:15:39', 200, 1, 0, 'Samsung tiếp tục trình làng mẫu smartphone giá rẻ mới với tên gọi Samsung Galaxy J2 Prime mang nhiều cải tiến đáng giá như kết nối 4G.', 0, 4, 2),
(55, 'Samsung Galaxy J2 Core', 'assets/img/j2c.png', '2390000', '2018-12-14 09:15:39', 200, 1, 0, 'Samsung Galaxy J2 Core là chiếc smartphone đầu tiên của Samsung mang trong mình hệ điều hành Android Go Edition được tinh chỉnh để hoạt động mượt và ổn định hơn', 0, 4, 2),
...
(57, 'Samsung Galaxy J4 Core', 'assets/img/j4c.png', '3090000', '2018-12-14 09:15:39', 200, 0, 0, 'Samsung Galaxy J4 Core là chiếc điện thoại thứ 2 của Samsung chạy trên nền tảng Android Go siêu nhẹ được tối ưu dành riêng cho những chiếc máy giá rẻ', 0, 4, 2),
...
(71, 'OPPO F7 128GB', 'assets/img/of7128.png', '7290000', '2018-12-14 09:15:39', 200, 0, 0, 'Tiếp nối sự thành công của OPPO F5 thì OPPO tiếp tục giới thiệu OPPO F7 128GB với mức giá tương đương nhưng mang trong mình thiết kế hoàn toàn mới cũng nhiều cải tiến đáng giá', 0, 2, 5),
...
(2, 'baotoan', 'ed7de67d31481f40495db3fa11c16f23', 'Bảo Toàn', 'Quận 10', '01627247666', 'hmbt@gmail.com', NULL, 0, ' assets/img/ava/baotoan/Hopstarter-Sleek-Xp-Basic-User-Group.ico', NULL, NULL, NULL),
(3, 'vy', 'ed7de67d31481f40495db3fa11c16f23', '  admin', '629B Bà Hạt Quận 10', '01627247666', 'hmbt@gmail.com', NULL, 0, NULL, NULL, NULL, NULL),
...
--
ALTER TABLE `chitietdonhang`
  MODIFY `MaChiTietDonHang` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
